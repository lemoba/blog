...
var ColorItem = function () {
  ...
  _createClass(ColorItem, [{
     ...
     * Hue formulas can be extended using ColorItem.colorFormulas bootstrap property.
     *
...
// model conversion methods and bootstrap constructors
Object.keys(convert).forEach(function (model) {
	...
	// 'bootstrap' construction methods
